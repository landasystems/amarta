...
<div style="text-align: center;"><h2>Laporan Pengambilan Proses Kerja</h2></div>
...
//        }
        $workOrderProcess = WorkorderProcess::model()->findAll(array(
            'condition' => 'workorder_id=' . $_POST['spk']
        ));
        foreach ($workOrderProcess as $value) {
            ...
            echo '<td>' . $taker . '</td>';
            echo '<td align="center" style="text-align:center;">' . $value->SPK->code . '</td>';
            ...
            echo '<td align="center" style="text-align:center;">' . $waktu . '</td>';
            echo '</tr>';
        }
        ?>
    </tbody>
