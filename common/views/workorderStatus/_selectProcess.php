...
//pengecekan sudah terambil belum
                ...
                if (!empty($workorderProcess)) {
                    ...
                    . '<a class="btn ambil" split_id="' . $val->id . '" workprocess_id="' . $ab->id . '" process_name="' . $ab->name . '" nopot="' . $val->code . '" desc="' . $sSize . '" charge="' . $ab->charge . '" start_qty="'.$val->qty.'" spk_id="'.$ab->workorder_id.'">'
