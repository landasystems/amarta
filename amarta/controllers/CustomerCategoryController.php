...
class CustomerCategoryController extends Controller {
    ...
    public function actionGenerateExcel() {
        ...
        if (isset($session['CustomerCategory_records'])) {
            $model = $session['CustomerCategory_records'];
        }
        else
            $model = CustomerCategory::model()->findAll();
    ...
    public function actionGeneratePdf() {
        ...
        $pdf->SetTitle('Laporan CustomerCategory');
        $pdf->SetSubject('Laporan CustomerCategory Report');
        //$pdf->SetKeywords('example, text, report');
        $pdf->SetHeaderData('', 0, "Report", '');
        //$pdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, "Laporan" CustomerCategory, "");
        $pdf->SetHeaderData("", "", "Laporan CustomerCategory", "");
        ...
        $pdf->LastPage();
        $pdf->Output("CustomerCategory_002.pdf", "I");
    }
