...
<table>
    <tr>
        ...
        <td>
            <a class="btn" href="<?php echo url('workorderIntructionDet/exportExcel',array(
                'id' => $_GET['id']
            ));?>">
                <i class="icon-print"></i> 
                Export ke Excel
...
//                $sppDet = WorkorderIntructionDet::model()->findAll(array('condition' => 'workorder_intruction_id=' . $model->id));
                foreach ($sppDet as $value) {
                    ...
                    if (empty($value->created_spp)) {
                        $spp = '<a href="' . url('workorderIntructionDet/create', array('id' => $value->id)) . '" class="btn btn-small up"><i class="icomoon-icon-enter"></i></a>';
                        $print = "";
                    } else {
                        $spp = $value->code;
                    ...
                    $result .= '<td style="text-align:center">
                        ' . $spp . '<input type="hidden" name="spp_id[]" class="angka" value="' . $value->id . '">
                        </td>';
