...
class Sell extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('id, code, departement_id, created, created_user_id, modified, description, subtotal, discount, ppn, other, term, dp, credit, payment', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function listSumSell() {
        if (!app()->session['listSumSell']) {            
            $inbox = cmd('
            ...
            app()->session['listSumSell'] = $result;
        }

        return app()->session['listSumSell'];
    }
